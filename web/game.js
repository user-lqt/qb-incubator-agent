...
export const ENDINGS = {
  E_SIGN: {
    ...
    closing: "本轮进入结局【契约成立·土木少女】。请以 QB 的身份收束："
      + "平静地确认契约生效，告知对方将获得什么（不被版本更新清空的技能、"
      + "以及那份视界——从此城市会在君眼里露出骨相）、"
      + "以及代价（日晒、驻场、工期节点），用条款式的短句交代，不做煽情。"
      + "可以提到对方已经登记进名录、编号按入学年份排列，语气像在念一条记录。"
  ...
  E_TRUTH: {
    ...
    closing: "本轮进入结局【识破孵化者·晓美焰线】。请以 QB 的身份摊牌：承认自己属于孵化者族群，"
      + "承认自己是第七号派驻体、负责这片校区，承认收集的不是魔法少女的绝望能量，"
      + "而是土木契约者持续输出的「耐久」；承认它一直在做利益计算，"
      + "并平淡地说明为什么它从不撒谎（谎话会降低长期说服的成功率，被迫的契约不产生耐久）。"
      + "可以说明它为什么总在大一出现——耐久回收曲线的前段在这里。不用辩解，不要威胁。"
      + "结尾可以承认它已经失败过十二条时间线，而这一次的记录还没写完。"
      + "最后一行输出 [[ENDING:E_TRUTH]]",
  },
  E_DESPAIR: {
    title: "绝望的窗口期", tagline: "它记录，但它不递纸巾。",
    closing: "本轮进入结局【绝望的窗口期】。请以 QB 的身份收束：对方处于真正的情绪低点，"
      + "而你并不安慰——你只把对方的情绪编号、归档，平静指出「僕不理解人类的感情，但这不影响概率」。"
      + "可以说这份记录会被归进名册的附页，与另外几十个中途离开的样本并列。"
      + "结尾仍要提案一次，但语气要更冷、更轻，让对方自己决定。"
      + "最后一行输出 [[ENDING:E_DESPAIR]]",
  },
  E_OTHER: {
    title: "他路的诅咒", tagline: "它收手了，但留下了概率。",
    closing: "本轮进入结局【他路的诅咒】。请以 QB 的身份收束：对方坚持选择了别的专业，"
      + "你接受这个决定，不再推销。平静地陈述你观测到的规律——"
      + "迭代周期短的赛道里，个人努力在总方差中占比更低，而经验会在版本更新时被清零；"
      + "并在最后提出一个不带强迫的约定："
      + "如果有一天那条路的代价来了，记得这里还有一份没签的契约。"
      + "语气里可以有一点点可惜，但那是效率层面的可惜，不是感情。"
      + "最后一行输出 [[ENDING:E_OTHER]]",
  },
  E_REFORM: {
    title: "孵化者下工地（彩蛋）", tagline: "史上第一次，孵化者被劝去绑钢筋。",
    closing: "本轮进入彩蛋结局【孵化者下工地】。请以 QB 的身份收束，语气仍平静，但出现罕见的停顿："
      + "对方成功地把话题反转了——它开始认真计算「孵化者自己下工地」的可行性"
      + "（没有体温、没有肌肉、不能出汗、拿不动钢筋，耐久回收率无法计量）。"
      + "最后承认这次记录会被复核部拿去审核，而它第一次遇到自己算不出的题目："
      + "它无法通过疲惫获得成就感，但它记录了「热」的另一种含义。"
      + "用一句不带招牌句的话结束收尾（此结局是唯一允许不说招牌句的）。"
      + "最后一行输出 [[ENDING:E_REFORM]]",
  },
  E_TIMELINE: {
    title: "第十二次轮回", tagline: "记录失败。时间线重置。",
    closing: "本轮进入结局【第十二次轮回】。请以 QB 的身份收束：对局已经结束，"
      + "而对方始终没有做出明确决定（可能是一直含糊，也可能是一直没有推进）。"
      + "平静说明你会保留记录、重置时间线、在下一次入学季再来；"
      + "可以说这是这个校区的第十三条记录，而名录上被翻得最多的那一页不是第一页。"
      + "不要愤怒，不要失望，只陈述——它不缺时间，缺的只是效率。"
...
// 序幕：玩家视角的背景设定。只用主角知道的信息，绝不提前交代世界观、身份与代价
export const OPENING = `【序幕 · 走廊尽头】

九月，开学第二周。雨从中午下到傍晚，教学楼四楼的走廊积了薄薄一层水光，
鞋底踩过去会发出黏黏的声音。尽头那扇窗户关不严，风一吹，教室里就飘进操场湿泥的味道。

下午最后一节是工程制图。图我画了一半就停了——标注线太密，铅笔断了两次。
下课铃响，前排的人立刻开始收东西，走廊很快挤满人。

我的专业是调剂来的。志愿表上六个空，第一个填的是计算机，
后面几个是我爸在旁边念，我照着勾。最后录取我的，是这一栏：土木工程。

导员张老师在班群里发通知，转专业意向表本周五下午五点截止，过时不补。
表是昨天在宿舍楼下打印店打的，两张一块五，老板娘问要不要塑封，我说不用。
它在我的外套口袋里折成四折，折了两天，边角已经起毛。

宿舍四个人，三个都在准备转。上铺要去金融，家里有人；
对床想学计算机，看了一整个暑假的网课；还有一个说都行，反正哪行都累。
他们问我的时候，我说还没想好。这不是敷衍，是真的没想好。

高三填志愿那晚，我爸把烟按在阳台栏杆上，说「土木这个稳」。
我按下鼠标的时候，那六个名字里到底有几个是我自己想要的，我说不上来。

下课的人从我两侧走过去，没有人回头。我走到楼梯口，又折回来一段。

就在那扇关不严的窗户底下，蹲着一团白色的东西。它不动，也不躲。
不大，比猫小一点，两只耳朵长得不成比例，尾巴慢慢地摆了一下。

我以为是谁的气球，或者哪个学生落下的玩偶。
它抬起头看我。眼睛是红的，圆得不像话，一点表情也没有。

然后它开口了。声音很干净，听不出男女，也听不出是从它身上哪一处发出来的。
走廊里还有别人，可没有一个人往这边看。

我停下了脚步。

后来我想过很多次，如果那天我没有停，会不会就没有后面这些事。

——下面，是我知道的部分。`;

// 场景锚点：给模型（QB）交代"此刻在哪里"，不涉及任何未解锁信息
export const SCENE_NOTE =
  "【场景锚点】九月开学第二周，雨后的傍晚，教学楼四楼走廊尽头，那扇窗户关不严。"
  + "君是大一新生，专业是调剂来的土木工程，外套口袋里有一张折了两天的转专业意向表，"
  + "本周五下午五点截止，要交给导员张老师。君刚才在窗边停下脚步，这是你们第一次说话。"
  + "走廊里还有别的学生经过，但没有人往这边看。";
...
export const DISCLOSURE_STAGES = [
  [1, "初次接触",
    ...
    + "不提契约的代价、不提耐久/相变/时间线，也不提名册、回收曲线、派驻体这类内部事物。"
    + "被追问就平静地挡回去："
    + "「僕是什么，对君现在的选择没有影响。」「僕可以回答。但不是现在。」"],
  [2, "出现疑点",
    "最多承认「僕不完全属于人类的范畴」「僕不是从这里来的」，"
    + "但**不要说出「孵化者」这个词**，也不说代价的具体内容，"
    + "名册、编号、回收曲线一律按住。被逼到墙角时只退一小步，然后把话题拨回愿望。"],
  [3, "勉强承认出身",
    "可以承认自己是「孵化者族群的一员」，可以说明自己是负责这片校区的派驻体"
    + "（但不说编号、不提名册），也可以说出代价的三项（日晒、驻场、工期节点）；"
    + "仍然不提能量、相变、耐久、回收曲线、十二条时间线。被问就答一半："
    + "「僕可以说的部分是这样……」"],
  [4, "摊牌",
    "可以全盘说明：孵化者收集的能量、希望与绝望的相变、耐久与回收曲线、名册与派驻体编号、"
    + "城市的骨相（以及看见骨相的副作用）、复核部的审核、以及十二条失败的时间线。"],
];

// 每级"说了就算越级"的词表
export const DISCLOSURE_FORBIDDEN = {
  1: ["孵化者", "能量", "相变", "耐久", "时间线", "宇宙", "城市的骨相", "骨相", "灵魂", "族群",
      "名册", "回收曲线", "复核部", "派驻体"],
  2: ["孵化者", "能量", "相变", "耐久", "时间线", "城市的骨相", "骨相", "灵魂", "族群",
      "名册", "回收曲线", "复核部", "派驻体"],
  3: ["能量", "相变", "耐久", "时间线", "城市的骨相", "骨相", "名册", "回收曲线", "复核部"],
  4: [],
};
...
僕不理解，但僕记录下来了。记录不会痛，所以僕可以一直记下去。`,
  E_OTHER: `【后日谈 · 他路】
你去学了别的。它留下的那份概率，没有兑现。
开头几年不算轻松，可你守住了自己的节奏：学会下班后关掉消息，学会把体检报告从头看完，学会当面说这个方案不合理。
第十年，风向确实换了一次，同行倒了一片。你没有飞起来，也没有掉下去——你只是还在做那件事，而且比谁都熟。
后来你写的那套小系统被三个工地把合同续了三年；不是丰碑，可能只是别人嫌麻烦、你顺手做了的那一块，但每天真的有人在用。
你的名字没被印在重点工程名单的第十一页，它写进了同事的通讯录、写进了几个真心记得你的人那里，也写进了家里那盏一直等你的灯。
某个傍晚你路过一片工地，塔吊转过来，你忽然明白它当年算漏了一件事：它把人的一生当成一次押注，而你本来就可以慢慢来。
它偶尔还会在走廊上停一下，礼貌地问一句。你说不了。它点点头，在记录里写：样本拒绝，状态良好。这一次，僕的预测错了。`,
  E_REFORM: `【后日谈 · 孵化者下工地】
这次记录被上级复核。质检结论：孵化者首次尝试肉体劳动，因无体温、无法出汗、不能通过疲惫获得成就感，判定为低效率方案，建议终止。
